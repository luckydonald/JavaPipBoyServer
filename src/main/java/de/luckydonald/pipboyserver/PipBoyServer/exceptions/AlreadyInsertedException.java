...
/**
 * Raised if a given {@link DBEntry} has a ID, which isn't in the given {@link Database},
 * or the {@link DBEntry}s id is wrong (there is an other element at that id)
 *
 */
public class AlreadyInsertedException extends Exception {
     ...
     * @since 1.7
     */
    protected AlreadyInsertedException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }
    public class AlreadyInsertedRuntimeException extends RuntimeException{
